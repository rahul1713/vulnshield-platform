...
export const MOCK_VULNERABILITIES: Vulnerability[] = [
  { id: '1', asset_id: '1', asset_name: 'prod-web-01', cve_identifier: 'CVE-2023-44487', title: 'HTTP/2 Rapid Reset Attack', severity: 'high', cvss_score: 7.5, status: 'open', category: 'denial_of_service', affected_software: 'nginx', affected_version: '1.18.0', exploit_available: true, patch_available: true, risk_score: 85.5, description: 'HTTP/2 Rapid Reset allows denial of service against nginx servers via rapid stream cancellation.', remediation: 'Upgrade nginx to 1.25.3 or later and enable rate limiting on HTTP/2 streams.', first_detected: '2024-03-15T00:00:00Z', last_detected: '2024-06-01T00:00:00Z' },
  { id: '2', asset_id: '4', asset_name: 'dev-app-01', cve_identifier: 'CVE-2021-44228', title: 'Log4Shell RCE', severity: 'critical', cvss_score: 10.0, status: 'in_progress', category: 'remote_code_execution', affected_software: 'log4j', affected_version: '2.14.1', exploit_available: true, patch_available: true, risk_score: 98.7, description: 'Remote code execution via JNDI lookup in Log4j logging framework.', remediation: 'Upgrade log4j to 2.17.1+ and remove JndiLookup class. Verify no vulnerable transitive dependencies.', first_detected: '2024-01-10T00:00:00Z', last_detected: '2024-06-01T00:00:00Z' },
  { id: '3', asset_id: '3', asset_name: 'win-dc-01', cve_identifier: 'CVE-2024-21413', title: 'Outlook RCE', severity: 'critical', cvss_score: 9.8, status: 'open', category: 'remote_code_execution', affected_software: 'Microsoft Outlook', exploit_available: true, patch_available: true, risk_score: 95.2, description: 'Microsoft Outlook remote code execution via malicious email preview.', remediation: 'Apply Microsoft security update KB5034763 immediately on all Exchange/Outlook clients.', first_detected: '2024-04-01T00:00:00Z', last_detected: '2024-06-01T00:00:00Z' },
  { id: '4', asset_id: '2', asset_name: 'prod-db-01', title: 'PostgreSQL Weak Authentication', severity: 'medium', cvss_score: 5.3, status: 'acknowledged', category: 'misconfiguration', affected_software: 'postgresql', exploit_available: false, patch_available: false, risk_score: 45.0, description: 'Database accepts md5 password authentication without certificate enforcement.', remediation: 'Enforce SCRAM-SHA-256 authentication and require TLS for all client connections.', first_detected: '2024-02-20T00:00:00Z', last_detected: '2024-06-01T00:00:00Z' },
  { id: '5', asset_id: '1', asset_name: 'prod-web-01', title: 'Missing Security Headers', severity: 'medium', cvss_score: 4.3, status: 'open', category: 'misconfiguration', affected_software: 'nginx', exploit_available: false, patch_available: false, risk_score: 38.5, description: 'HTTP responses missing HSTS, CSP, X-Frame-Options, and X-Content-Type-Options headers.', remediation: 'Configure security headers in nginx server block. Enable HSTS with includeSubDomains.', first_detected: '2024-05-01T00:00:00Z', last_detected: '2024-06-01T00:00:00Z' },
];
...
export const MOCK_REPORTS: Report[] = [
  { id: '1', name: 'Executive Summary Q2', report_type: 'executive', format: 'pdf', status: 'completed', generated_at: '2024-06-01T00:00:00Z', created_at: '2024-06-01T00:00:00Z', source_entity_key: 'scan:1' },
